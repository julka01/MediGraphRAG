...
User Query: {question}"""),
    ...
    def get_vanilla_rag_context(self, query: str, document_names: List[str] = None, similarity_threshold: float = 0.1, max_chunks: int = 20, kg_name: str = None) -> Dict[str, Any]:
        """
    ...
    def generate_response(self, question: str, llm, document_names: List[str] = None, similarity_threshold: float = 0.1, max_chunks: int = 20, extra_context_texts: Optional[List[str]] = None, kg_name: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            context = self.get_vanilla_rag_context(question, document_names=document_names, similarity_threshold=similarity_threshold, max_chunks=max_chunks, kg_name=kg_name)
