  ...
  return (
    <div className="flex flex-col gap-3 min-w-0">
      ...
      <div className="flex items-center gap-3 my-2">
        <div className="h-px flex-1 bg-linear-to-r from-transparent to-base-content/20" />
        <div className="size-1 rounded-full bg-base-content/20" />
        <div className="h-px flex-1 bg-linear-to-l from-transparent to-base-content/20" />
      </div>
