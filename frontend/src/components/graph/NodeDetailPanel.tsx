...
export function NodeDetailPanel({ node, nodeColor, onClose }: NodeDetailPanelProps) {
  ...
  return (
    <div className="absolute top-0 right-0 w-72 h-full z-20 animate-slide-from-right">
      <div className="card card-border bg-base-100 h-full shadow-lg rounded-none rounded-l-lg">
        <div className="card-body p-4 overflow-y-auto">
          ...
          <span className="badge badge-sm badge-soft" style={{ color: nodeColor, borderColor: nodeColor }}>
            {nodeType}
          </span>
