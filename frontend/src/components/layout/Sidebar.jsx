...
export function Sidebar({ kgModelHook, ragModelHook, onNeo4jOpen, onProgressStart, onProgressStop }) {
  ...
  return (
    <div className={`relative flex flex-col bg-base-200 border-r border-base-300 transition-all duration-300 overflow-y-auto ${
      ...
      <div className="p-3 space-y-4">
        ...
        <div>
          ...
          <div className="mt-2">
            <KGPanel kgModelHook={kgModelHook} onNeo4jOpen={onNeo4jOpen} onProgressStart={onProgressStart} onProgressStop={onProgressStop} />
          </div>
        </div>
